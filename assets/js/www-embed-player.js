...
b=Dj("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof ig&&b.abort();
return fg(c)})}
...
function gs(){var a=window.location.protocol,b=S.getEntriesByType("resource");b=fb(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
...
try{nt("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}ut.push(bf.N(function(){if(!(vt||"google_ad_status"in window)){try{tt("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}vt=!0;Zh("DCLKSTAT",3)}},5E3))}}
...
B("PL_ATT")&&Ft.dispose();for(var a=bf,b=0,c=ut.length;b<c;b++)a.T(ut[b]);ut.length=0;st("//static.doubleclick.net/instream/ad_status.js");vt=!1;Zh("DCLKSTAT",0);qe(Vu,Uu);Tu&&(Tu.removeEventListener("onVideoDataChange",Wu),Tu.destroy())});
